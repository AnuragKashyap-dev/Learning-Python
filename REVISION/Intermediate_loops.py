...
smallest = l[0]
for nums in l :
    if nums%2 == 0 and nums<smallest :
        smallest = nums
print(smallest)

# Q41.Count numbers greater than 50.

l = [3,2,32,4,3,1234,2342,4234,234,443,544,54,29]
greaterthan50 = 0
for nums in l:
    if nums > 50 :
        greaterthan50 += 1
...
for numbers in positive_numbers:
    sum = sum + numbers
...
# 🔹 Challenge Questions
# Q46.Find the second largest distinct element.
